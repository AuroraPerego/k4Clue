 ...
 */
#ifndef CLDBarrelLayerTilesConstants_h
#define CLDBarrelLayerTilesConstants_h

#include "constexpr_cmath.h"
#include <array>

struct CLDBarrelLayerTilesConstants {
  // Global r*phi coordinate
  static constexpr float minX = -7400.f;
  static constexpr float maxX = 7400.f;
...
#endif  // CLDBarrelLayerTilesConstants_h
